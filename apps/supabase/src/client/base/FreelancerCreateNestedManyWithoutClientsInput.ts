...
@InputType()
class FreelancerCreateNestedManyWithoutClientsInput {
...
export { FreelancerCreateNestedManyWithoutClientsInput as FreelancerCreateNestedManyWithoutClientsInput };
