...
@InputType()
class ContractCreateNestedManyWithoutFreelancersInput {
...
export { ContractCreateNestedManyWithoutFreelancersInput as ContractCreateNestedManyWithoutFreelancersInput };
