...
@InputType()
class ProposalCreateNestedManyWithoutFreelancersInput {
...
export { ProposalCreateNestedManyWithoutFreelancersInput as ProposalCreateNestedManyWithoutFreelancersInput };
